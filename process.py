...
from classes import ImageIntegrator, CurveInterpolator


def integrateImage(image_list: List[np.array], spline_x: UnivariateSpline, spline_y: UnivariateSpline, t_vals: np.array, arc_points: np.array):
        """
